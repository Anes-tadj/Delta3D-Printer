...
#define STRING_CONFIG_H_AUTHOR "(Anes, ENPO)" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 90.00 // mm

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 334.00 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 251.70 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 181.34 //mm  Get this value from auto calibrate
